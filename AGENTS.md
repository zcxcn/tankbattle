...
- 当前沉淀基线为 0.4.14；实际版本以 `pc-godot/export_presets.cfg` 为准。[0.4.14 自检](docs/pc-realistic/SELF_CHECK_0.4.14.md)记录主菜单选车卡顿修复，[0.4.13 自检](docs/pc-realistic/SELF_CHECK_0.4.13.md)记录丘陵树林地图，[0.4.12 自检](docs/pc-realistic/SELF_CHECK_0.4.12.md)记录敌车视野/追击/远射，[0.4.10 自检](docs/pc-realistic/SELF_CHECK_0.4.10.md)记录性能/巨怪追击/续波，[Mac 导出说明](docs/pc-realistic/MACOS_EXPORT_0.4.8.md)记录跨平台流程。
