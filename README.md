...
网页版使用固定屏幕部署菜单，战役按六章翻页，车库分为底盘、装备、成长和升级；全局关闭文字划选。点击“快速作战”可选择 **尘湾城区、苍岩高地、赤沙荒漠、雨林河谷、断轨货场、雾湾湿地** 六张地图，并组合歼灭突击、信标防守、区域控制、车队护送、情报撤离、设施破袭、纵深突破、限时生存八种任务。有限任务均需击毁 Boss；快速作战保留坦克成长，不解锁战役章节。

敌人在北侧区域分散随机部署，每次重新开局使用新种子，并避开实体掩体、其他敌车和玩家附近。山体与水域具有通行限制，桥梁提供过河通道；城区增加高楼，厂房、办公楼和货箱可被炮弹打坏，出现弹痕与裂损后倒塌为可通行的低矮废墟。铁路、树林和自然地表按地图生成，共用已有贴图，不增加模型下载。

进入战场使用真实进度条：提前载入引擎、分批创建场景，再核验首屏材质与光照，完成首帧后开始计时和战斗；支持取消和重试。声音资源在首屏可玩后继续准备，未加载完时使用已有合成音效。较远物体和禁用废墟的着色器不再阻塞入场。

手机支持横屏与竖屏：左摇杆移动，拖动右摇杆瞄准开火，也可按住“自动瞄准”；点“布雷”布雷，点“排雷”清除范围内双方地雷。横竖屏均默认收起武器栏，点底部“换武器”展开后左右滑动选择；雷达通过右上角雷达图标开关。手机首次进入默认 30 帧、省电场景细节与高清分辨率，可在首页右上角设置中分别调整。
...
手机战场采用精简 HUD：半透明双摇杆和技能贴近两侧，中央保留视野；文字提示、英文字幕与升级消息合并为画布外的顶部单行，齐射预警和装甲危急优先显示，语音播报保留。Boss 血条接近交战时才显示，任务详情与声音控制可在暂停菜单查看。
