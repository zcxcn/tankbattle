...
路面、混凝土、砖墙、金属、土壤和树皮使用 6 套 Poly Haven CC0 实拍 PBR 材质（18 张贴图，4.26 MiB）；连同新封面新增约 6.35 MiB 本地图片。来源、作者和许可见 [材质说明](web/assets/surfaces/README.md)，生成方式与完整提示词见 [封面说明](web/assets/COVER.md)。这些资源通过带哈希的网页模块加载，Android 与 PC 版本均保持原样。
