...
README = """钢铁余烬 · Iron Embers 0.4.9 / macOS Universal
...
def main() -> None:
    ...
    manifest = {"product": "Iron Embers", "version": "0.4.9", "engine": "Godot 4.7.2", "architecture": "universal (arm64 + x86_64)", "signing": "ad-hoc; not notarized", "runtime_test": "not run on macOS", "files": []}
